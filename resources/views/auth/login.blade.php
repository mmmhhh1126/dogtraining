...
<body>
    <div class="uerlogin">
            ...
            <div class="adminbox">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <p>
                            <input id="password" class="logintextbox" type="password" name="password" required autocomplete="current-password" />
                        </p>
        ...
        <div class="admin-signup logintext wf-nicomoji">
            <a href="{{ route('register') }}">しんきとうろく</a>

        </div>

    </div>
    <div class="userpic wf-nicomoji logintext admin-signst">
            <a href="{{ url('/user') }}">スタートへもどる</a>
    </div>
</body>
